...
### `> Fachinformatiker Systemintegration` · `📡 Germany` · `🟢 Available`
 
*„Ich halte IT-Umgebungen am Laufen – und ja, ich hab's mit Neustart versucht."*
...
![VoIP](https://img.shields.io/badge/VoIP_SIP-00ADB5?style=for-the-badge&logo=googlemeet&logoColor=white)
...
> Self-hosted Infrastruktur auf **Proxmox VE 9** — VMs & LXC-Container, always-on.
 
- 🤖 **Home Assistant OS** (VM) — Smart Home Automatisierung, Zigbee via Zigbee2MQTT & Mosquitto
- 🔇 **Pi-hole v6** (LXC) — netzwerkweiter DNS-Blocker
- 💾 **Samba** — lokaler NAS-Share
- 🛜 **ESPHome** — DIY-Automatisierungen (in Planung: Smart-Türklingel & -Öffner via ESP32)
- ☁️ **Cloudflare + INWX** — DNS-Management & Hosting
---
 
## 🚀 Projekte
 
> Repos sind größtenteils privat — hier ein Überblick was so läuft.
 
---
 
### 🏆 wwe_rating *(aktiv)*
**WWE Show-Bewertungsplattform** — RAW, SmackDown, PLEs und SNME bewerten, Statistiken verfolgen, persönliche Ratings archivieren.
...
![Status](https://img.shields.io/badge/Status-Live-00F5C4?style=flat-square)
 
---
 
### 📅 urlaubstracker *(aktiv)*
**Persönliche Urlaubsverwaltung** — ersetzt Excel, bietet intelligente Vorschläge für Brückentage und Jahresplanung.
...
### 💪 sportapp *(in Entwicklung)*
**Fitness Tracking Web-App** — Trainings loggen, Fortschritt visualisieren, Challenges mit Freunden.
 
**Features:** Training Tracker · Körpergewicht-Chart · 1RM Kraftentwicklung · Foto Timeline · Social · Challenges · XP & Badge System · PWA
...
![Status](https://img.shields.io/badge/Status-In_Arbeit-F59E0B?style=flat-square)
 
---
 
### 🌐 ping-me-maybe *(Portfolio)*
Mein IT-Portfolio — Praxisprojekte, Skills, Kontakt.
...
![Status](https://img.shields.io/badge/Status-Live-00F5C4?style=flat-square)
[![Website](https://img.shields.io/badge/→_ping--me.jnphl.de-111?style=flat-square)](https://ping-me.jnphl.de)
 
---
 
### 🛍️ JP-Shop-v1 *(privat)*
E-Commerce Projekt — private Trikot-Anfrageplattform für Bundesliga & Nationalmannschaft Kollektionen mit Anfrage-Warenkorb und persönlichem Service.
 
![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white)
![Next.js](https://img.shields.io/badge/Next.js-000?style=flat-square&logo=nextdotjs)
![Prisma](https://img.shields.io/badge/Prisma-2D3748?style=flat-square&logo=prisma)
![Status](https://img.shields.io/badge/Status-Archiviert-6B7280?style=flat-square)
